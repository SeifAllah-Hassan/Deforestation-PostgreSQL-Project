...
CREATE TABLE "regions" (
    ...
    "region"	VARCHAR(512),
    "income_group"	VARCHAR(512)
);

INSERT INTO "regions" ("country_name", "country_code", "region", "income_group") 
VALUES
	...
	('Cote d Ivorie', 'CIV', 'Sub-Saharan Africa', 'Lower middle income'),
	('Croatia', 'HRV', 'Europe & Central Asia', 'High income'),
	('Cuba', 'CUB', 'Latin America & Caribbean', 'Upper middle income'),
	('Curacao', 'CUW', 'Latin America & Caribbean', 'High income'),
	...
	('Ṣo Tom̩ and Principe', 'STP', 'Sub-Saharan Africa', 'Lower middle income'),
